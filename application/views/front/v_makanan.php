                    ...
                    <div id="blog" class="container section">
                        ...
                        ?>
                            <div class="blog-item">
                                ...
                                <h2 class="blog"><a href="<?php echo base_url().'makanan/detail_makanan/'.$idberita;?>"><?php echo $judul;?></a></h2>
                                ...
                                <p>
                                    <a href="<?php echo base_url().'makanan/detail_makanan/'.$idberita;?>" class="small gray button">Read more ...</a>
                                </p>
                            </div>
                            <?php
                            }
                        ...
                        <div id="sidebar-content" class="one-third column last">
                            ...
                            <div class="sidebar-item">
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo base_url().'makanan/detail_makanan/'.$idberita;?>"><img width="50" height="50" src="<?php echo base_url().'assets/gambars/'.$gbr;?>" alt="" /><?php echo $judul;?></a>
