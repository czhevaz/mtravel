                    ...
                    <div id="blog" class="container section">
                        <div id="blog-content" class="two-third column end">
                            <div id="post-content" class="blog-item">
                                <img width="700" height="400" src="<?php echo base_url().'assets/gambars/'.$n['photo'];?>" alt="">
                                <h2 class="blog"><a href="single.html"><?php echo $n['nama'];?></a></h2>
                                <p class="blog-item-meta">
                                    <?php echo $n['date_created'];?>, by <?php echo $n['created_by'];?> <a href="#"></a>
                                </p>
                                <p>
